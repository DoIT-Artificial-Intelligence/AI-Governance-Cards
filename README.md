...
* [Developer Roadmap (Mandatory Do's and Don'ts)](#developer-roadmap-mandatory-dos-and-donts)
...
* [Executive Order Catalyzing the Responsible and Productive Use of Artificial Intelligence in Maryland State Government](https://governor.maryland.gov/media/741/download)
...
* **Approved Versions:** Use only versions of coding assistants that do not train on code, data, or other artifacts, such as Enterprise or Government solutions. Individual or free versions that require you to permit training on State data are prohibited​.
...
* **Accountability:** Before committing, <b>you must fully understand the code and be able to explain how it works:</b> “AI did it" is not an acceptable excuse for bugs or security incidents.
...
![AI Coding Assistants: Risks and Mitigation Strategies](images/ai-risks-7-mdwds-nonumbered%20(1).png)
*This governance card's author created this image using Claude.ai, specifying in their prompt that this image must comply with the Maryland Web Design System (MWDS).*
...
* **Intellectual Property and Copyright:** AI may reproduce licensed code verbatim, raising the risk of copyright infringement or license violations.
    * **Mitigation:** Enable public code filt​ers. If a coding assistant suggests a substantial block of text, manually search public repositories to ensure compliance with open-source licenses.
...
* **Data Overexposure:** The coding assistant receives more codebase context than necessary​​.
...
* 🟢 **Approved (Government Versions):**
    ...
    * **GitHub Copilot:** Allowed via its Enterprise version. Requires mandatory opt-out of data training and use of public code filters.
...
To request licenses for the tools above, email [doit.intake@maryland.gov](doit.intake@maryland.gov) and cc your agency's portfolio officer.
...
​The State of Maryland applies thi​s same lens to coding assistants. We pledge to always use AI in service to State residents, employees, and organizations. That involves using AI like coding assistants to deliver state services more effectively. Keeping Maryland’s civil servants in the driver’s seat empowers the State to innovate responsibly.

For additional support, explore Maryland's AI resources and tools at the State's official [AI website](https://ai.maryland.gov/).
